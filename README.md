...
Projeto desenvolvido como parte do desafio de Excel da Digital Innovation One (DIO). A proposta foi construir uma ferramenta que permita simular aportes mensais em fundos imobiliários, estimar o patrimônio acumulado e projetar os dividendos mensais.
...
Na aba APP, altere somente as células em azul;

Informe salário, taxas, aporte, prazo e perfil;

Observe a atualização automática dos resultados, cenários, distribuição e gráfico.
